...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 301f7c92-be7c-4e0c-b308-fddecb982b5a
```

> `301f7c92-be7c-4e0c-b308-fddecb982b5a` is the password of the certificate, you can change it to any password you want.
