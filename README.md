...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c8ded74b-bb8e-4f65-9979-421243785286
```

> `c8ded74b-bb8e-4f65-9979-421243785286` is the password of the certificate, you can change it to any password you want.
